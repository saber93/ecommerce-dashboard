-- Inventory claims follow available units, including products with illustrative images.
-- Photo verification remains separate; no product stock or orders are modified.
