...
('blush-duo','The Rose Top Handle','Soft structure, everyday polish','face',16500,'./assets/bag-rose.png','','[]',true,true,20),
('lip-pair','The Mauve Mini','A compact companion for every plan','lips',14000,'./assets/bag-mauve.png','','[]',true,true,20),
('eye-palette','The Cognac Tote','Room for everything, refined shape','face',22000,'./assets/bag-tan-tote.png','','[]',true,true,20),
...
('lip-liner','The Burgundy Crossbody','A hands-free classic in rich burgundy','eyes',11000,'./assets/bag-burgundy.png','','[]',true,true,20),
('eye-sticks','The Espresso Hobo','Easy shape, effortless carry','eyes',13500,'./assets/bag-espresso.png','','[]',true,true,20)
